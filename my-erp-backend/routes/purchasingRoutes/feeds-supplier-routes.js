...
const FeedsSupplierController = require('../../Controllers/main-purchasing-controller/feeds-supplier-controller');
const pool = require('../../config/database');
const controller = new FeedsSupplierController(pool);
