    ...
    async confirmBatchPayroll(payrollIds, payPeriodStart, payPeriodEnd) {
        ...
        try {
            ...
            const batchResult = await client.query(
                `INSERT INTO batch_payroll (batch_id, batch_reference, pay_period_start, pay_period_end, payroll_count, total_gross_pay, total_gross_deduction, total_net_pay, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, 'Pending') RETURNING *`,
                [batchReference, batchReference, payPeriodStart, payPeriodEnd, payrollData.rows.length, totalGrossPay.toFixed(2), totalGrossDeduction.toFixed(2), totalNetPay.toFixed(2)]
            );
